...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	settingHandler := handler.ProvideAdminSettingHandler(settingService, emailService, turnstileService, aliyunCaptchaService, opsService, paymentConfigService, paymentService, userAttributeService, notificationEmailService, billingModeService, totpService, userService)
	...
	ensembleHandler := handler.ProvideEnsembleHandler(ensembleRuntimeService, billingService, modelPricingResolver, contentModerationService, coordinator)
