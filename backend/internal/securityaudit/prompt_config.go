...
func PublicFromStorage(cfg storageConfig, riskControlEnabled bool, invalidTokenEndpointIDs []string) PublicConfig {
	...
	return PublicConfig{
		Enabled: cfg.Enabled, BlockingEnabled: cfg.BlockingEnabled, SecretGuardMode: cfg.SecretGuardMode, BlockingLatestTurnOnly: cfg.BlockingLatestTurnOnly, StorePassEvents: cfg.StorePassEvents,
...
func ActiveFromStorage(cfg storageConfig, riskControlEnabled bool, encryptor SecretEncryptor) (ActiveConfig, error) {
	active := ActiveConfig{
		...
		SecretGuardMode: cfg.SecretGuardMode, BlockingLatestTurnOnly: cfg.BlockingLatestTurnOnly,
...
func changeSummary(cfg storageConfig) string {
	...
	}{cfg.Enabled, cfg.BlockingEnabled, cfg.SecretGuardMode, cfg.BlockingLatestTurnOnly, cfg.StorePassEvents, len(cfg.Endpoints), len(cfg.Scanners), cfg.AllGroups, len(cfg.GroupIDs), ""}
