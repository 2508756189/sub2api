...
func (m *ConfigManager) buildNextStorage(current storageConfig, req UpdateConfigRequest, actorID int64) (storageConfig, error) {
	...
	next := storageConfig{
		Enabled: req.Enabled, BlockingEnabled: req.BlockingEnabled, SecretGuardMode: req.SecretGuardMode, BlockingLatestTurnOnly: req.BlockingLatestTurnOnly, StorePassEvents: req.StorePassEvents,
