...
func registerGroupRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	groups := admin.Group("/groups")
	{
		...
		groups.GET("/:id/ensemble-proposers", h.Admin.Group.ListEnsembleProposers)
		groups.POST("/:id/ensemble-proposers", h.Admin.Group.CreateEnsembleProposer)
		groups.PUT("/:id/ensemble-proposers/:proposer_id", h.Admin.Group.UpdateEnsembleProposer)
		groups.DELETE("/:id/ensemble-proposers/:proposer_id", h.Admin.Group.DeleteEnsembleProposer)
		groups.GET("/:id/ensemble-config", h.Admin.Group.GetEnsembleConfig)
		groups.PUT("/:id/ensemble-config", h.Admin.Group.UpdateEnsembleConfig)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/billing-mode", h.Admin.Setting.GetBillingMode)
		adminSettings.PUT("/billing-mode", h.Admin.Setting.UpdateBillingMode)
