...
const apiKeyAuthSnapshotVersion = 20 // v20: include current group pricing fields; group long-context and model pricing fields (force refresh of pre-fix snapshots)
