...
describe('admin order currency display', () => {
  it('uses order currency for paid/base/fee amounts and platform currency for credited/refund amounts', () => {
  ...
  it('uses order currency for pay_amount and platform currency for refundable balance amounts', () => {
