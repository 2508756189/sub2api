export default {
    settings: {
      ...
      payment: {
        ...
        billingMode: {
          title: 'Platform Settlement Currency',
          description: 'Choose the currency used for user balances, quotas, and usage invoices. Upstream model and channel prices remain USD-denominated.',
          current: 'Current: {currency}',
          settlementCurrency: 'Settlement currency',
          cny: 'Chinese yuan (CNY)',
          usd: 'US dollar (USD)',
          sourcePriceHint: 'Model catalog and channel source prices are not rewritten when the platform currency changes.',
          rate: 'USD to CNY rate',
          rateHint: 'Used for ledger conversion between USD and CNY. Changing the rate within one currency affects future billing only.',
          switchTitle: 'Existing platform amounts will be converted',
          switchHint: 'The switch converts balances, API key quotas, department limits, usage reports, affiliate balances, and batch-job billing snapshots in one transaction. Payment orders and plan prices keep their own currencies.',
          factor: 'Conversion factor',
          example: 'Example amount',
          backupConfirm: 'I have backed up the database and will run the conversion during a low-traffic window.',
          confirmLabel: 'Type {phrase} to continue:',
          historyHint: 'Each currency switch records its factor and timestamp. Changing the rate does not revalue historical bills.',
          saveSuccess: 'Settlement settings saved.',
          switchSuccess: 'Settlement currency switched; {rows} records converted.',
        },
        ...
        balanceRechargeMultiplierHint: 'How much CNY platform balance the user receives for each CNY paid',
        balanceRechargePreview: 'Preview: 1 CNY paid = {usd} CNY platform balance',
