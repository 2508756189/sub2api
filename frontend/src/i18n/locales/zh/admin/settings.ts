export default {
    settings: {
      ...
      payment: {
        ...
        billingMode: {
          title: '平台结算币种',
          description: '选择平台对用户余额、额度和用量账单使用的结算币种。上游模型和渠道原价仍按美元维护。',
          current: '当前：{currency}',
          settlementCurrency: '结算币种',
          cny: '人民币（CNY）',
          usd: '美元（USD）',
          sourcePriceHint: '模型目录和渠道原价不因平台币种切换而改写。',
          rate: '美元兑人民币汇率',
          rateHint: '用于美元与人民币之间的账务换算；在同一币种下调整汇率只影响后续计费。',
          switchTitle: '这会换算现有平台金额',
          switchHint: '切换币种将事务化换算余额、API Key 额度、部门限额、用量报表、联盟余额和批量任务账务快照。支付订单与套餐价格保持原币种。',
          factor: '本次换算倍率',
          example: '示例金额',
          backupConfirm: '我已完成数据库备份，并确认在低峰期执行换算。',
          confirmLabel: '请输入 {phrase} 以继续：',
          historyHint: '每次币种切换都会记录换算倍率和时间；修改汇率不会重算历史账单。',
          saveSuccess: '结算设置已保存。',
          switchSuccess: '结算币种已切换，已换算 {rows} 条记录。',
        },
        configGuide: '支付配置指南',
        enabled: '启用支付',
        ...
        balanceRechargePreview: '预览：支付 1 元 = {usd} 元平台余额',
